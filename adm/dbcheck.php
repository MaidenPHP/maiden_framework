...
$tb[]="city";					if( MAP_SYS==1 ) $cl[]="`id`, `owner`, `name`, `last_update`, `galaxy`, `system`, `pos`, `img`";
								else $cl[]="`id`, `owner`, `name`, `last_update`";
$tb[]="city_builds";			$cl[]="`id`, `city`, `build`, `lev`, `func`";
$tb[]="city_build_que";			$cl[]="`id` ,  `city` ,  `build` ,  `end`";
$tb[]="city_research_que";		$cl[]="`id` ,  `usr` ,  `res_id` ,  `end`";
...
for($i=0;$i!=count($tb);$i++){
	if( mysql_query("SELECT ".$cl[$i]." FROM ".TB_PREFIX.$tb[$i]) ){$tbr[$i]="Ok"; $tbc[$i]="#006600";}else{$tbr[$i]=$lang['adm_broken']; $tbc[$i]="#CC0000";}
}	
...
$body="<b>
	...
	phpSGE db version: <span class='Stile3'>".db_ver()."</span><br>
