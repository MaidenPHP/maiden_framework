...
-- Database: `maiden_db`
--
CREATE DATABASE IF NOT EXISTS `maiden_db` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `maiden_db`;
...
GRANT USAGE ON *.* TO 'maiden_db'@'localhost' IDENTIFIED BY PASSWORD '*B807E6B9C07ADD2E3CE3AB0E44003454B3F105BF';
GRANT SELECT, INSERT, UPDATE, DELETE ON `maiden_db`.* TO 'maiden_db'@'localhost';
