...
'adm_status' 			=> 'Stato',
'adm_broken' 			=> 'Rotta',
'adm_config'			=> 'Modifica Configurazione / Rates',
'adm_dbcheck'			=> 'Controllo Database',
'adm_buildings'			=> 'Costruzioni',
'adm_research'			=> 'Ricerche',
// -------------------------------- LABELS - INSTALLER ------------------------------- //
'ins_installintro' 		=> "<p>ATTENZIONE!<span class='Stile3'><strong> Se sei su Linux imposta CHMOD a 777 o fai l' <a href='http://sourceforge.net/apps/mediawiki/phpstrategygame/index.php?title=Manual_installation'>Instalazione manuale (clik qua)!</a></strong></span></p>	<p><b>Necessiti aiuto?</b> Visita: <a href='http://sourceforge.net/apps/mediawiki/phpstrategygame/index.php?title=Installation_guide'>PhpSgeX wiki: Guida d'installazione</a> per una guida!</p><p>Installando PhpSgeX accetti di sottostare alle regole di licenza</p>",
